...
//           description:
//             'You have no active subscription. Subscribe to continue using Ai Tutor!',
//           action: {
//             label: 'Subscribe',
...
export default function Chat({
  ...
  // (Ex. will show on all chats after creating a new session or messaging Ai Tutor, even the first chat).
  // Also, clearing chats will revert the message to the initial description.
  const defaultMessage: Message = {
    content: `${firstChat ? "I'm Ai Tutor, your Aristotelian learning companion," : "Welcome back! I'm"} here to guide your intellectual journey.
...
What's on your mind? Let's dive in. 🌱`,
  ...
  async function addChat() {
    ...
    try {
      ...
      mutateConversations([
        ...
        ...conversations!.filter((c: Conversation) => c.conversationId !== tempId),
      ]);
  ...
  async function chat(message?: string) {
    ...
    sessionStorage.setItem("sessionId", chatResponse.session_id);
    ...
    <main className="relative flex flex-1 w-full bg-background min-h-0">
      <ResizablePanelGroup direction="horizontal" className="h-full">
        ...
        <ResizablePanel defaultSize={isMobile ? 100 : 75}>
          ...
          <div className={`flex flex-col h-full w-full relative ${!isSubscribed ? 'pt-12 md:pt-[63px]' : ''}`}>

            {/* {!isSubscribed && (
              <section
                className="absolute top-0 left-0 h-[63px] w-full bg-neon-green text-primary-foreground text-center flex items-center justify-center shrink-0"
              >
                <p>
                  {freeMessages === 0
              ...
              <div className="px-4 py-3.5 border-b-2 border-border flex justify-start items-center gap-3.5 overflow-hidden ">
                ...
                <div className="flex justify-start items-center gap-5">
                  ...
                  <button
                    ...
                    // disabled={!canUseApp}
                    disabled
                    className="w-10 h-10 bg-[#174fa3] rounded-full flex justify-center items-center overflow-hidden hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 w-full">
                          <PromptInputAction tooltip="Attach files" className="text-white">
